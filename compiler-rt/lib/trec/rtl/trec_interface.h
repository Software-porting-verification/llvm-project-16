...
extern "C"
{
    ...
    SANITIZER_INTERFACE_ATTRIBUTE void __trec_write1(void *addr, bool isPtr,
                                                     void *val,
                                                     __sanitizer::u64 addr_sa,
                                                     __sanitizer::u64 val_sa,
                                                     __sanitizer::u64 debugID);
    ...
    SANITIZER_INTERFACE_ATTRIBUTE void __trec_unaligned_read2(
        const void *addr, bool isPtr, void *val, __sanitizer::u64 sa,
        __sanitizer::u64 debugID);
    ...
    SANITIZER_INTERFACE_ATTRIBUTE void __trec_unaligned_write2(
        void *addr, bool isPtr, void *val, __sanitizer::u64 addr_sa,
